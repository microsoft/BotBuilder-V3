...
After testing locally, the next step is to put your bot somewhere accessible from the cloud.  In this tutorial, we use Microsoft Azure to host the Bot application - though you can host wherever your like. To publish your Bot Application you will need a Microsoft Azure subscription. You can get a free trial from here: https://azure.microsoft.com/en-us/ 
