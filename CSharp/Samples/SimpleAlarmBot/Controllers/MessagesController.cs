...
namespace Microsoft.Bot.Sample.SimpleAlarmBot
{
    ...
    public class MessagesController : ApiController
    {
        ...
        {
            var simpleFluentAlarm = SimpleFluentAlarmBot.Instance;
            var simpleAlarm = SimpleAlarmBot.Instance;
            var dialogs = new DialogCollection().Add(simpleFluentAlarm).Add(simpleAlarm);
            return await ConnectorSession.MessageReceivedAsync(Request, message, dialogs, simpleAlarm);
        }
