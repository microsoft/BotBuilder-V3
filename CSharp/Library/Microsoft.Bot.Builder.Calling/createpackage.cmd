...
..\..\packages\NuGet.CommandLine.3.5.0\tools\NuGet.exe pack Microsoft.Bot.Builder.Calling.nuspec -symbols -properties version=%version%;builder=%builder% -OutputDirectory ..\nuget
