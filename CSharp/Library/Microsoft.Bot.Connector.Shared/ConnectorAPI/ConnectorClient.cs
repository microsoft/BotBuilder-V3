...
namespace Microsoft.Bot.Connector
{
    ...
    public partial class ConnectorClient : ServiceClient<ConnectorClient>, IConnectorClient
    {
        ...
        protected ConnectorClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient: disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public ConnectorClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
