...
//    {
//        private static readonly IDictionary<string, TrustedHostInfo> TrustedHostNames = new Dictionary<string, TrustedHostInfo>()
//        {
//            // { "state.botframework.com", DateTime.MaxValue }, // deprecated state api
//            { "api.botframework.com", new TrustedHostInfo() { DateTime = DateTime.MaxValue } },       // bot connector API
//            { "token.botframework.com", new TrustedHostInfo() { DateTime = DateTime.MaxValue } },    // oauth token endpoint
//            { "api.botframework.azure.us", new TrustedHostInfo() { DateTime = DateTime.MaxValue } },        // bot connector API in US Government DataCenters
//            { "token.botframework.azure.us", new TrustedHostInfo() { DateTime = DateTime.MaxValue } },      // oauth token endpoint in US Government DataCenters
//        };
...
//        /// <remarks>The expiration time will default to DateTime.UtcNow.AddDays(1).</remarks>
//        public static void TrustServiceUrl(string serviceUrl, string oauthScope = null)
//        {
//            TrustServiceUrl(serviceUrl, DateTime.UtcNow.Add(TimeSpan.FromDays(1)), oauthScope);
//        }
...
//        /// <param name="oauthScope">(optional) The scope to use while retrieving the token.  If Null, 
//        /// MicrosoftAppCredentials.OAuthBotScope will be used.</param>
//        public static void TrustServiceUrl(string serviceUrl, DateTime expirationTime, string oauthScope = null)
//        {
//            lock (TrustedHostNames)
//            {
//                TrustedHostNames[new Uri(serviceUrl).Host] = new TrustedHostInfo() { DateTime = expirationTime, OAuthScope = oauthScope };
//            }
//        }
...
//            lock (TrustedHostNames)
//            {
//                if (TrustedHostNames.TryGetValue(uri.Host, out TrustedHostInfo trustedHostInfo))
//                {
//                    // check if the trusted service url is still valid
//                    if (trustedHostInfo!= null && trustedHostInfo.DateTime > DateTime.UtcNow.Subtract(TimeSpan.FromMinutes(5)))
//                    {
//                        return true;
//                    }
//                }
