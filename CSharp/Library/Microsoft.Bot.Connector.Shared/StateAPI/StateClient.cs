...
namespace Microsoft.Bot.Connector
{
    ...
    public partial class StateClient : ServiceClient<StateClient>, IStateClient
    {
        ...
        /// True: will dispose the provided httpClient on calling StateClient.Dispose(). False: will not dispose provided httpClient</param>
        protected StateClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient: disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public StateClient(ServiceClientCredentials credentials, HttpClient httpClient, bool disposeHttpClient) : this(httpClient, disposeHttpClient)
        {
            if (credentials == null)
            {
                throw new System.ArgumentNullException("credentials");
