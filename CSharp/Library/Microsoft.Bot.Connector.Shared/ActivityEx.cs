...
namespace Microsoft.Bot.Connector
{
        ...
        ITriggerActivity
    {
        ...
        /// </summary>
        protected bool IsActivity(string activity) { return string.Compare(this.Type?.Split('/').First().ToLower(), activity.ToLower()) == 0; }
        ...
        {
            return this.Entities?.Where(entity => String.Compare(entity.Type.ToLower(), "mention") == 0).Select(e => e.Properties.ToObject<Mention>()).ToArray() ?? new Mention[0];
        }
