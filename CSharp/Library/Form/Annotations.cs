...
namespace Microsoft.Bot.Builder.Form
{
    ...
    public enum TemplateUsage { Clarify, CurrentChoice, Feedback, Help, HelpClarify, HelpNavigation, HelpOneNumber, HelpManyNumber, HelpOneWord, HelpManyWord,
        NextStep, NoPreference, NotUnderstood, SelectOne, SelectMany, String };
