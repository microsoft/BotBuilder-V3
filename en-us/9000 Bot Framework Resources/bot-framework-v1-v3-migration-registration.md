...
3. Click the Version 3.0 endpoint radio button, and save your changes.
    ...
    <div class="docs-text-note"><strong>Note:</strong>  if you downgrade to Version 1.0, and have an active Skype bot, <a href="mailto:botframework@microsoft.com">contact us</a> to have your Skype bot reset.</div>
